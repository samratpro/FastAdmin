...
Copy the prompt block below and paste it into your AI coding assistant to quickly set up, configure, and automate the deployment files for FastAdmin on a VPS server.
...
I want to deploy FastAdmin in a secure, production-ready environment on a Linux VPS.
...
2. `docker-compose.yml`:
   - Setup separate services for `api` (FastAPI Node.js), `admin` (Next.js start), and optionally `postgres`.
