# AI Prompt: Build Stunning Public Frontend Consuming FastAdmin

Copy the prompt block below and paste it into your AI coding assistant to design a premium, highly responsive user-facing React/Next.js application that integrates with the FastAdmin API.
...
I want to build a stunning, premium, and state-of-the-art public frontend website that connects to my FastAdmin FastAPI API backend (which runs on port 8000 by default).
