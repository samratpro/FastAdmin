...
- After you grant access, backup files can be uploaded to a `FastAdmin_backup/` folder in your Drive
...
3. Give it a name (e.g. `FastAdmin-backup`) → **Create**
...
3. If prompted, click **Configure Consent Screen** first:
   ...
   - Fill in **App name** (e.g. `FastAdmin Backup`), **User support email**, **Developer contact email**
...
5. The popup closes automatically and the banner turns green:
   > *"Google Drive connected (OAuth2) — uploads go to FastAdmin_backup/"*
...
4. The file is uploaded to a `FastAdmin_backup/` folder in your Google Drive
...
6. Optional — share the `FastAdmin_backup` folder with your Gmail so files appear in your Drive:
   ```env
