...
This guide explains how to connect your own user-facing app to FastAdmin without mixing it into the admin panel.
...
That is the intended integration model in FastAdmin.
